function [Fx,Fy] = Flux_closure15(M4)
% Flux_closure computes 2-D HyQMOM closure for Fluxes
%
%   Input:
...
% flux closures
Fx = [M50 M41 M32 M23 M14];
Fy = [M05 M14 M23 M32 M41];
