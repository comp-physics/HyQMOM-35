...
%
%surface(x,y,z4,C1,'Linestyle','none')
surface(x,y,z5,C2,'Linestyle','none','FaceAlpha',FaceAlpha)
surface(x,y,z6,C3,'Linestyle','none','FaceAlpha',FaceAlpha)
