...
# Export 3D unsplit flux functions
export rotate_moments_to_normal, rotate_flux_from_normal, compute_3d_flux

# Export full moment rotation utilities (for validation tests)
export rotate_moments_z90, rotate_moments_z90_inverse
export permute_grid_z90, permute_grid_z90_inverse, rotate_full_state_z90_inverse
...
include("numerics/flux_3d_unsplit.jl")
...
include("utils/full_moment_rotation.jl")
