...
function hyqmom_3D(S300, S400, S110, S210, S310, S120, S220, S030, S130, S040,
    ...
    S320 = ((S030*S300^2)/2 - S030 + S030*(S300^2 - S400 + 1))*S110 + (S400 - (3*S300^2)/2)*S120 + 
           (-(3*S030*S300)/2)*S210 + ((3*S300)/2)*S220 + S030*S310 - S300/2
    S230 = ((S300*S030^2)/2 - S300 + S300*(S030^2 - S040 + 1))*S110 + (S040 - (3*S030^2)/2)*S210 + 
           (-(3*S300*S030)/2)*S120 + ((3*S030)/2)*S220 + S300*S130 - S030/2
    
    S302 = ((S003*S300^2)/2 - S003 + S003*(S300^2 - S400 + 1))*S101 + (S400 - (3*S300^2)/2)*S102 + 
           (-(3*S003*S300)/2)*S201 + ((3*S300)/2)*S202 + S003*S301 - S300/2
    S203 = ((S300*S003^2)/2 - S300 + S300*(S003^2 - S004 + 1))*S101 + (S004 - (3*S003^2)/2)*S201 + 
           (-(3*S300*S003)/2)*S102 + ((3*S003)/2)*S202 + S300*S103 - S003/2
    
    S032 = ((S003*S030^2)/2 - S003 + S003*(S030^2 - S040 + 1))*S011 + (S040 - (3*S030^2)/2)*S012 + 
           (-(3*S003*S030)/2)*S021 + ((3*S030)/2)*S022 + S003*S031 - S030/2
    S023 = ((S030*S003^2)/2 - S030 + S030*(S003^2 - S004 + 1))*S011 + (S004 - (3*S003^2)/2)*S021 + 
