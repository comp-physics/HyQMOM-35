...
% Pack 3D arrays into canonical 35-element vectors using linear indexing
% Order: [000,100,200,300,400,010,110,210,310,020,120,220,030,130,040,
%         001,101,201,301,002,102,202,003,103,004,011,111,211,021,121,
%         031,012,112,013,022]
idx_c = [sub2ind([5 5 5], 1,1,1), sub2ind([5 5 5], 2,1,1), sub2ind([5 5 5], 3,1,1), ...
         sub2ind([5 5 5], 4,1,1), sub2ind([5 5 5], 5,1,1), sub2ind([5 5 5], 1,2,1), ...
         sub2ind([5 5 5], 2,2,1), sub2ind([5 5 5], 3,2,1), sub2ind([5 5 5], 4,2,1), ...
         sub2ind([5 5 5], 1,3,1), sub2ind([5 5 5], 2,3,1), sub2ind([5 5 5], 3,3,1), ...
         sub2ind([5 5 5], 1,4,1), sub2ind([5 5 5], 2,4,1), sub2ind([5 5 5], 1,5,1), ...
         sub2ind([5 5 5], 1,1,2), sub2ind([5 5 5], 2,1,2), sub2ind([5 5 5], 3,1,2), ...
         sub2ind([5 5 5], 4,1,2), sub2ind([5 5 5], 1,1,3), sub2ind([5 5 5], 2,1,3), ...
         sub2ind([5 5 5], 3,1,3), sub2ind([5 5 5], 1,1,4), sub2ind([5 5 5], 2,1,4), ...
         sub2ind([5 5 5], 1,1,5), sub2ind([5 5 5], 1,2,2), sub2ind([5 5 5], 2,2,2), ...
         sub2ind([5 5 5], 3,2,2), sub2ind([5 5 5], 1,3,2), sub2ind([5 5 5], 2,3,2), ...
         sub2ind([5 5 5], 1,4,2), sub2ind([5 5 5], 1,2,3), sub2ind([5 5 5], 2,2,3), ...
         sub2ind([5 5 5], 1,2,4), sub2ind([5 5 5], 1,3,3)];
