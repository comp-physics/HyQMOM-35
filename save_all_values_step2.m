% Save ALL intermediate values after step 2
clear all;
close all;
...
params = struct();
params.Np = Np;
params.tmax = 0.04;  % Should give us exactly 2 steps
params.Kn = Kn;
params.Ma = Ma;
...
fprintf('Running MATLAB for 2 steps...\n');
script_dir = pwd;
...
save('matlab_step2_all_values.mat', 'result', '-v7.3');

fprintf('\n=== MATLAB Step 2 Complete ===\n');
...
fprintf('\nSaved to matlab_step2_all_values.mat\n');
